...
namespace cfg {
  ...
  inline vk::PhysicalDevicePresentModeFifoLatestReadyFeaturesEXT presentModeFifoLatestReadyFeatures = 
      vk::PhysicalDevicePresentModeFifoLatestReadyFeaturesEXT()
          .setPresentModeFifoLatestReady(true);
  ...
  inline vk::PhysicalDeviceRobustness2FeaturesKHR robustness2Features = 
      vk::PhysicalDeviceRobustness2FeaturesKHR()
          ...
          .setPNext(&presentModeFifoLatestReadyFeatures);
