  ...
  inline void renderPipelineStateWindow()
  {
    ...
    if (ImGui::CollapsingHeader("Primitive State", ImGuiTreeNodeFlags_DefaultOpen)) {
      ...
      const char* topologyNames[] = {
        ...
        "TriangleStrip", "TriangleFan", "LineListWithAdjacency",
        "LineStripWithAdjacency", "TriangleListWithAdjacency", "TriangleStripWithAdjacency", "PatchList"
      };
